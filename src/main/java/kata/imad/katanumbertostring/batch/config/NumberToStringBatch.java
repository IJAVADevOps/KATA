package kata.imad.katanumbertostring.batch.config;
...
public class NumberToStringBatch {
//jobLuancher --> job --> Step --> item reader
//                          |--- item processor
//                          | --- item write
    private final NumberToStringService numberToStringService;
    @Autowired
    public NumberToStringBatch(NumberToStringService numberToStringService) {
                ...
                .processor(
                        item -> {
                            try {
                                ...
                                return number+" "+numberToStringService.transformNumberToString(number);
